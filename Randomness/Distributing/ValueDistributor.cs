...
/// <summary>
/// Represents a randomizer that distributes a number value across multiple elements of an array using weighted distribution.
...
{
    /// <summary>
    /// The System.<see cref="System.Random"/> object utilized by the <see cref="ValueDistributor"/> object.
    /// </summary>
    public Random Random { get; set; }

    /// <summary>
    /// Initializes a new <see cref="ValueDistributor"/> object with a provided System.<see cref="System.Random"/> object.
    /// </summary>
    /// <param name="random">The System.<see cref="System.Random"/> object to be provided.</param>
    public ValueDistributor(Random random)
    {
        Random = random;
    }

    /// <summary>
    /// Initializes a new <see cref="ValueDistributor"/> object with a new System.<see cref="System.Random"/> instance.
    /// </summary>
    public ValueDistributor() : this(new Random()) { }
    ...
    /// <param name="weightModifier">The <see cref="IWeightDistributionPolicy"/> implementers to be used. (optional)</param>
    ...
    /// </remarks>
    public void Distribute(int value, int[] target, params IWeightDistributionPolicy[] weightModifier)
    {
        ...
        GenerateWeights(weights, weightModifier, out double weightSum);
    ...
    /// <param name="weightModifier">The <see cref="IWeightDistributionPolicy"/> implementers to be used. (optional)</param>
    public int[] Distribute(int value, int spread, params IWeightDistributionPolicy[] weightModifier)
    {
        int[] target = new int[spread];
        Distribute(value, target, weightModifier);
        return target;
    }
    ...
    /// This method mutates <paramref name="target"/> in place.
    /// </remarks>
    public void Distribute(long value, long[] target, params IWeightDistributionPolicy[] weightModifier)
    {
        // reject elementless arrays
        if (target.Length < 1) throw new ArgumentException("Target array must have a length of at least one.");
    ...
    /// <param name="spread">The amount of number elements to receive the distributed value.</param>
    /// <param name="weightModifier">The <see cref="IWeightDistributionPolicy"/> implementers to be used. (optional)</param>
    public long[] Distribute(long value, int spread, params IWeightDistributionPolicy[] weightModifier)
    {
    ...
    /// This method mutates <paramref name="target"/> in place.
    /// </remarks>
    public void Distribute(double value, double[] target, params IWeightDistributionPolicy[] weightModifier)
    {
        // reject elementless arrays
        if (target.Length < 1) throw new ArgumentException("Target array must have a length of at least one.");
    ...
    /// <param name="spread">The amount of number elements to receive the distributed value.</param>
    /// <param name="weightModifier">The <see cref="IWeightDistributionPolicy"/> implementers to be used. (optional)</param>
    public double[] Distribute(double value, int spread, params IWeightDistributionPolicy[] weightModifier)
    {
    ...
    /// This method mutates <paramref name="target"/> in place.
    /// </remarks>
    public void Distribute(decimal value, decimal[] target, params IWeightDistributionPolicy[] weightModifier)
    {
        // reject elementless arrays
        if (target.Length < 1) throw new ArgumentException("Target array must have a length of at least one.");
    ...
    /// <param name="spread">The amount of number elements to receive the distributed value.</param>
    /// <param name="weightModifier">The <see cref="IWeightDistributionPolicy"/> implementers to be used. (optional)</param>
    public decimal[] Distribute(decimal value, int spread, params IWeightDistributionPolicy[] weightModifier)
    {
    ...
    private void DistributeRemainder<T>(Span<T> targetValues, Span<T> distributedValues, Span<double> weights, int remainder) where T : INumber<T>
    {
        ...
        for (int i = 0; i < demands.Length; i++)
        {
            ...
            else if (demand > highestDemandIndices.Peek())
            {
